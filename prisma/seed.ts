...
async function main() {
  ...
  const waterproofing = await prisma.productCategory.create({
    data: {
      ...
      slug: "waterproofing",
      description:
        "Advanced waterproofing solutions to shield structures from water damage.",
    },
  });
  ...
  const woodAdhesives = await prisma.productCategory.create({
    data: {
      ...
      description:
        "Premium white adhesives for carpenters and furniture makers.",
    },
  });
  ...
  const polyurethane = await prisma.material.create({
    data: {
      ...
      description:
        "Tough, flexible material with high durability and elastic joint capabilities.",
    },
  });
  ...
  const acrylic = await prisma.material.create({
    data: {
      ...
      description:
        "Excellent UV-resistant polymer for waterproofing coatings.",
    },
  });
  ...
  const prod1 = await prisma.product.create({
    data: {
      ...
      description:
        "Premium water-resistant white wood adhesive ideal for bonding wood, plywood, laminate, and veneers.",
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Two-component acrylic-modified cementitious liquid applied waterproofing coating.",
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Single-component high-performance polyurethane joint sealant.",
  ...
  // 5. Seed Use Cases
  // ==========================================
  console.log("🏗️  Use Case seeding...");
  ...
  await prisma.useCase.create({
    data: {
      ...
      description:
        "Strong, heat-resistant, and anti-termite wood bonding solutions suitable for assembling cabinets and laminate liners in modern kitchens.",
    },
  });
  ...
  await prisma.useCase.create({
    data: {
      ...
      description:
        "Applying elastomeric liquid membranes to prevent water seepage through concrete roof slabs during severe monsoons.",
    },
  });
  ...
  await prisma.issue.create({
    data: {
      ...
      problem:
        "Rainwater seepage through micro-cracks on concrete roofs damages paint, causes mold, and weakens structural rebars.",
      solution:
        "Clean the roof surface thoroughly. Apply Jivanjor WaterShield 2K with glass fibre mesh reinforcement, followed by a UV-resistant acrylic topcoat.",
    },
  });
  ...
  await prisma.issue.create({
    data: {
      ...
      problem:
        "Moisture ingress or using sub-standard adhesive causes laminates to peel away or bubble at the edges of wooden furniture.",
      solution:
        "Ensure the wood substrate has <12% moisture. Use Jivanjor AllRounder with uniform spread, clamping securely for at least 4 hours for a lifelong bond.",
    },
  });
  ...
  await prisma.blogPost.create({
    data: {
      ...
      content:
        "Water leaks are a nightmare for any house owner. In this guide, we walk you through the key areas prone to leaks—including bathroom floors, balconies, and outer walls—and explain how to pick the right compound sealants and acrylic coatings to prevent expensive concrete damage.",
  ...
  await prisma.blogPost.create({
    data: {
      ...
      content:
        "Not all white glues are made equal. From standard PVAs to advanced D3/D4 water-resistant formulations, this technical article outlines performance metrics—like green strength, setting time, and moisture immunity—to help carpenters choose the ultimate glue for solid wood and modular fittings.",
  ...
  await prisma.sEOMetadata.create({
    data: {
      ...
      metaDescription:
        "Discover Jivanjor's wide range of premium wood white adhesives, high-grade silicones, and advanced waterproofing solutions for long-lasting construction.",
  ...
  await prisma.sEOMetadata.create({
    data: {
      pageType: "STATIC",
      pageId: "ABOUT_PAGE",
      metaTitle: "About Jivanjor - Leading Construction Chemical Brand",
      metaDescription:
        "Learn about Jivanjor's historical commitment to quality, research, and crafting state-of-the-art polymer formulations for builders and carpenters worldwide.",
  ...
  await prisma.sEOMetadata.create({
    data: {
      ...
      metaDescription:
        "Buy Jivanjor AllRounder white wood adhesive. Highly water-resistant, fast-dry formulation engineered for modular cabinets, laminates, and veneer pasting.",
    ...
    data: {
      ...
      sections: {
        hero: {
          ...
          subtitle:
            "Superior strength adhesives crafted with state-of-the-art polymer chemistry to safeguard your woodworking and furniture creations for a lifetime.",
        ...
        adhesiveRange: {
          ...
          subtitle:
            "From premium wood glues to water-resistant formulations, explore adhesives trusted by master carpenters across India.",
          items: [
            {
              id: "champ-super",
              name: "Champion Super",
              description:
                "Premium white carpentry adhesive providing superior initial grab and high bonding strength.",
            ...
            },
            {
              ...
              name: "FastBond",
              description:
                "Fast-drying polymer glue designed to reduce assembly times for fast-track modular fittings.",
            ...
            },
            {
              ...
              name: "WaterShield 2K",
              description:
                "Acrylic-modified waterproofing glue that acts as a reliable moisture barrier for wet areas.",
        ...
        findAdhesive: {
          ...
          subtitle:
            "Select your application category to discover matched adhesives engineered for maximum hold.",
          items: [
        ...
        whyTrustUs: {
          ...
          subtitle:
            "Over decades, builders and contractors have endorsed Jivanjor for quality, innovation, and support.",
          items: [
            {
              title: "Consistent Quality",
              description:
                "Every batch is rigorously tested in our labs to ensure matching bonding performance.",
              iconName: "award",
            },
            {
              title: "Ease of Application",
              description:
                "Engineered viscosity allows smooth, even spreading with minimal effort.",
              iconName: "check-circle",
            },
            {
              title: "Range of Products",
              description:
                "A tailored product for every surface—from solid wood to rigid PVC and terrace concrete.",
              iconName: "layers",
            },
            {
              title: "Preferred by Experts",
              description:
                "Loved by leading interior designers, architects, and professional carpentry guilds.",
              iconName: "users",
            },
          ],
        },
        showcaseGrid: {
          ...
          subtitle:
            "Empowering woodworking communities with tools, training, and resources to scale their craftsmanship.",
          items: [
            {
              title: "Technical Resources",
              description:
                "Step-by-step tutorials, safety datasheets, and best practices for modern carpenter guilds.",
            ...
            },
            {
              ...
              description:
                "Available at 15,000+ retail outlets across India, backed by robust distribution networks.",
            ...
            },
            {
              ...
              description:
                "Recognized by woodworking associations for superior chemical safety and durability.",
        ...
        ctaPromo: {
          ...
          subtitle:
            "Connect with a Jivanjor representative today to get bulk pricing, specialized product trainings, and contractor loyalty rewards.",
        ...
        testimonials: {
          ...
          subtitle:
            "Hear from professional contractors and carpenters who build their reputation on Jivanjor daily.",
          videos: [
            {
              author: "Aarav Mehta",
        ...
        knowledgeBase: {
          ...
          subtitle:
            "Explore insights, tips, and chemistry guides from our experts to optimize your bonding applications.",
          items: [
            {
              title: "Choosing the Right Adhesive",
              summary:
                "A masterclass on selecting between standard PVA, quick-drying fast bonds, and high-performance polyurethanes.",
            ...
            },
            {
              ...
              summary:
                "Pro tips for surface preparation, wood moisture content checks, clamping times, and curing environment controls.",
            ...
            },
            {
              ...
              summary:
                "Learn how to prevent wood laminate bubbling, edge peeling, and joint cracking in high-humidity climates.",
  ...
  // Link the template to the home page
